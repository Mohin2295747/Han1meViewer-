...
fun View.click(lifecycle: Lifecycle, onClick: View.OnClickListener) {
  clickFlow().onEach { onClick.onClick(it) }.launchIn(lifecycle.coroutineScope)
}
 ...
 */
fun View.clickWithCondition(lifecycle: Lifecycle, @IdRes tag: Int, onClick: View.OnClickListener) {
  // 第一次点击总是成功的
  setTag(tag, true)
  clickFlow()
    .onEach {
