...
/**
 * Sets whether the decor view should fit root-level content views for {@link WindowInsetsCompat}.
 *
 * <p>
 * If set to {@code false}, the framework will not fit the content view to the insets and will just
 * pass through the {@link WindowInsetsCompat} to the content view. </p>
 *
 * <p>
 * Please note: using the {@link View#setSystemUiVisibility(int)} API in your app can conflict with
 * this method. Please discontinue use of {@link View#setSystemUiVisibility(int)}. </p>
 *
