...
class UtilUnitTest {
  ...
  fun formatFileSizeV2_isCorrect() {
    ...
    assertEquals("1.00 KiB", 1024L.formatFileSizeV2(decimalPlaces = 2, stripTrailingZeros = false))
    ...
    assertEquals("1.0 MB", 1_000_000L.formatFileSizeV2(useSi = true, stripTrailingZeros = false))
  ...
  fun md5_calculatesCorrectHashForLargeFile() {
    val file = File.createTempFile("largeFile", ".txt").apply { writeText("a".repeat(10_000_000)) }
