...
class HRvItemAdapter(
  ...
  companion object {
    fun RecyclerView.Adapter<*>.withTitleSection(
      ...
      val titleAdapter =
        VideoColumnTitleAdapter(titleResId).apply { onMoreHanimeListener = onMoreListener }
      val contentAdapter =
        this.wrappedWith { LinearLayoutManager(null, LinearLayoutManager.HORIZONTAL, false) }
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    val titleRecyclerView =
      RecyclerView(linearLayout.context).apply {
        layoutParams =
