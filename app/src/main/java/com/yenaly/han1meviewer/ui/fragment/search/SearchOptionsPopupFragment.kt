    ...
    binding.tag.apply {
      setOnClickListener {
        HMultiChoicesDialog(context, R.string.tag)
          .apply {
            addTagScope(R.string.video_attr, viewModel.tags[R.string.video_attr], spanCount = 1)
            addTagScope(R.string.relationship, viewModel.tags[R.string.relationship], spanCount = 2)
            addTagScope(R.string.characteristics, viewModel.tags[R.string.characteristics])
            addTagScope(
    ...
    binding.sortOption.apply {
      setOnClickListener {
        ...
        requireContext().showAlertDialog(
          ...
          val index = viewModel.sortOptions.indexOfFirst { it.searchKey == viewModel.sort }
    ...
    binding.duration.apply {
      setOnClickListener {
        ...
        requireContext().showAlertDialog(
          ...
          val index = viewModel.durations.indexOfFirst { it.searchKey == viewModel.duration }
