...
private constructor(private val context: Context, private val navController: NavController) {
  companion object {
    ...
    /** 适用于 activity 跳转 */
    @JvmStatic
    fun with(navController: NavController) = SettingsRouter(navController.context, navController)
  }
  ...
  fun toSettingsActivity(@IdRes id: Int = 0, bundle: Bundle? = null) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
      @Suppress("DEPRECATION") activity.overridePendingTransition(R.anim.fade_in, R.anim.fade_out)
    }
  }
