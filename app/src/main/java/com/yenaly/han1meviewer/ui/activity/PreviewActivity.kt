  ...
  override fun initData(savedInstanceState: Bundle?) {
    ...
    binding.rvTourSimplified.apply {
      ...
      ViewCompat.setOnApplyWindowInsetsListener(this) { view, _ ->
        val elementWidth = view.resources.getDimension(R.dimen.video_cover_simplified_width_small)
          ...
          override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
            ...
            if (newState == RecyclerView.SCROLL_STATE_IDLE) {
              if (shouldTriggerScroll) {
                ...
                val position = view?.let(::getChildAdapterPosition) ?: RecyclerView.NO_POSITION
