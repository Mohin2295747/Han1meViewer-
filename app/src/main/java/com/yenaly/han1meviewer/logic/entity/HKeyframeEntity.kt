...
data class HKeyframeEntity(
  ...
  class KeyframeTypeConverter {
    @TypeConverter
    fun fromKeyframeList(keyframes: MutableList<Keyframe>): String = Json.encodeToString(keyframes)

    @TypeConverter
    fun toKeyframeList(keyframes: String): MutableList<Keyframe> = Json.decodeFromString(keyframes)
  }
}
